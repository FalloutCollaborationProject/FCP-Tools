...
namespace FCP_Ghoul
{
    public class PawnRenderNode_BodyGlow : PawnRenderNode
    {
        public PawnRenderNode_BodyGlow(Pawn pawn,PawnRenderNodeProperties props, 
            PawnRenderTree tree) 
        ...
        public override Graphic GraphicFor(Pawn pawn)
        {
            ...
            return bodyGraphic.GetColoredVersion(props.shaderTypeDef.Shader, 
