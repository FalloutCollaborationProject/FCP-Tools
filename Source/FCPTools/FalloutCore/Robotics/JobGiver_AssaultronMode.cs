...
{
    public class JobGiver_AssaultronMode : JobGiver_AIFightEnemy
    {
        ...
        protected override Job TryGiveJob(Pawn pawn)
        {
            ...
            if (modeComp.Mode == AssaultronMode.GuardPawn && modeComp.GuardedPawn != null && modeComp.GuardedPawn.Spawned)
            {
        ...
        protected override bool ExtraTargetValidator(Pawn pawn, Thing target)
        {
            ...
            CompAssaultronMode modeComp = pawn.GetComp<CompAssaultronMode>();
            if (modeComp?.Mode == AssaultronMode.Assault)
            {
                return true;
            }

            if (modeComp?.Mode == AssaultronMode.GuardPawn && modeComp.GuardedPawn != null)
            {
